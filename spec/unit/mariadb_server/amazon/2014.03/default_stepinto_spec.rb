...
describe 'stepped into mariadb_test_default::server on amazon-2014.03' do
  ...
  let(:my_cnf_5_5_content_default_amazon_2014_03) do
    '[client]
port                           = 3306
...
SET PASSWORD FOR 'root'@'127.0.0.1' = PASSWORD('ilikerandompasswords');"
  ...
  context 'when using default parameters' do
    ...
    it 'steps into mariadb_service and renders file[/etc/my.cnf]' do
      expect(amazon_2014_03_default_run).to render_file('/etc/my.cnf').with_content(
        my_cnf_5_5_content_default_amazon_2014_03
        )
    end
    ...
    it 'steps into mariadb_service and runs execute[wait for mariadb]' do
      expect(amazon_2014_03_default_run).to run_execute('wait for mariadb')
    end
